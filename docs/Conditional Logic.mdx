...
title: Bit form - Conditional Logic
...
- Record Create/Edit : Executes the rule when records are created and or existing records are modified. See the example below :
  <Video
    src="Bit-Form-workflow-create-edit"
    alt="Condition-logic"
    w="800"
    h="400"
  />
...
**_On Form Load :_** The On Form Load action is used to dynamically alter a Form when it is loaded. The Form actions ***On Form Load*** is executed when the Form is loaded by a user.
...
<Video
  src="Bit-Form-On-Form-Load-Always"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
**_On Field Input :_** The On Field input is a client side action which will be called whenever the value of a field is modified either by the user . It is used to improve the usability of a form by validating field data even before it is submitted or display other field values based on the value specified in this field. The On Field input is executed before the changed data is persisted in the database.
...
<Video
  src="Bit-Form-On-Field-Input-Condition"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
<Video
  src="Bit-Form-On-Form-validate-message"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
<Video
  src="Bit-Form-On-Form-Submit-success-message-and-page-redirects"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
**_Workflow condition :_** You can create multiple conditions in a workflow rule. Each condition consists of two elements. One is specifying which records should be triggered i.e. all records or the records that match the criteria. Another is adding the criteria based on which it should be triggered.

**3. Action Behavior –**

**_Always :_** The action in a workflow executes for all records by default when the action behavior field is set as Always.

**_Condition :_** Executes the workflow via conditional logic. Rule will be triggered for the records that meet the criteria.

In condition you can use many kinds of logic. Here’s some examples of condition:

<Video
  src="Bit-Form-workflow-condition"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
<Video
  src="Bit-Form-workflow-condition1-1.gif-min-1"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
<Video
  src="Bit-Form-workflow-condition3.gif-min"
  alt="Condition-logic"
  w="800"
  h="400"
/>
...
<Video
  src="Calculations-via-custom-valuess"
  alt="Condition-logic"
  w="800"
  h="400"
/>

> **_Notice: Bit Form allows only the number field for calculation._**
