...
1. Before setting up the integration, you must confirm that the ***Fluent CRM plugin*** is activated on your site. Otherwise, the integration will not work.
 ...
 <Image src="Fluent-CRM/1_Fluent CRM- Bit Form" alt="Fluemt-CRM" w="1020" h="300" />
 ...
 ***Settings => Integrations =>  Click on (+) => Click on ‘Fluent CRM’.***
 ...
 <Image src="Fluent-CRM/3_Settings to integration- Bit Form" alt="Fluemt-CRM" w="1020" h="300" />

 <Image src="Fluent-CRM/4_Click on +- Bit Form" alt="Fluemt-CRM" w="1020" h="300" />
