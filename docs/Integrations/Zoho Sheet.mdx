---
id: zoho-sheet
title: Bit Form Integration With Zoho Sheet 
...
<Image src="Zoho Sheet/1.create_form" alt="Zoho Sheet" w="1020" h="350" />
...
<Image src="Zoho Sheet/2.Homepage" alt="Zoho Sheet" w="1020" h="350" />

<Image src="Zoho Sheet/3.Bit-Form-to-Zoho-Sheet-integration-select" alt="Zoho Sheet" w="1020" h="350" />
...
<Image src="Zoho Sheet/4.Bit-Form-to-Zoho-Sheet-api-console" alt="Zoho Sheet" w="1020" h="350" />

<Image src="Zoho Sheet/5.GetStarted" alt="Zoho Sheet" w="1020" h="350" />

<Image src="Zoho Sheet/6.api-console-server-based" alt="Zoho Sheet" w="1020" h="350" />

Fill those fields (Homepage URL and Authorized Redirect URLs) the same as your Integration Homepage. Then click ***UPDATE***.

<Image src="Zoho Sheet/7.Bit-Form-to-Zoho-Sheet-client-details" alt="Zoho Sheet" w="1020" h="350" />

A Client ID and a Client Secret will be generated. Then go to the Client Secret tab.

<Image src="Zoho Sheet/8.Bit-Form-to-Zoho-Sheet-client-secret" alt="Zoho Sheet" w="1020" h="350" />
...
<Image src="Zoho Sheet/9.Bit-Form-to-Zoho-Sheet-integration-homepage" alt="Zoho Sheet" w="1020" h="350" />

<Image src="Zoho Sheet/10.Bit-Form-to-Zoho-Sheet-accept" alt="Zoho Sheet" w="1020" h="350" />

<Image src="Zoho Sheet/11.Bit-Form-to-Zoho-Sheet-authorizations" alt="Zoho Sheet" w="1020" h="350" />

Select the all required (Workbook, Worksheet, Header Row) from the dropdown.

<Video src="12.Bit-Form-to-Zoho-Sheet-workbook-map" alt="Zoho Desk" w="1020" h="350" />
...
<Image src="Zoho Sheet/Example" alt="Zoho Sheet" w="1020" h="250" />
...
On the above example, If “Age” less than 18 and “Name” equal “Rubel” then Category will be “Teenager“.
