...
<Image src="Bit-Form-single-entry-for-ip-address" alt="New-Form" w="1000" h="300" />
...
<Image src="Form-Settings/Require-Log-In-Bit-Form" alt="New-Form" w="1000" h="230" />
...
<Image src="Form-Settings/Disallow-Empty-Form-Bit-Form" alt="New-Form" w="1000" h="250" />
...
<Image src="Form-Settings/Focus-Lost-Bit-Form" alt="New-Form" w="1000" h="250" />

### Disable entry storing in WordPress database
Enabling this option your form submission data will not be stored in Bit Form responses.

<Image src="Form-Settings/Data-Storing-Bit-Form" alt="New-Form" w="1000" h="250" />
...
<Image src="Bit-Form-limited-entry" alt="New-Form" w="1000" h="300" />
...
<Image src="Honeypot-Bit-Form (2)" alt="New-Form" w="1000" h="300" />
...
<Image src="Bit-Form-limit-period" alt="New-Form" w="1000" h="300" />
...
<Image src="Bit-Form-block-ip" alt="New-Form" w="1000" h="300" />
...
<Image src="Bit-Form-allowed-ip" alt="New-Form" w="1000" h="300" />
...
<Image src="SMTP/SMTP_1" alt="New-Form" w="1000" h="650" />
...
<Image src="SMTP/Gmail" alt="New-Form" w="346" h="500" />

✔ Navigate to the **Security** option. From this option you will find **Less security Apps** window.

<Image src="SMTP/1.Security" alt="New-Form" w="324" h="431" />

<Image src="SMTP/2.App-access-window" alt="New-Form" w="852" h="260" />

✔ Now, turn ON the **Allow less secure apps**.

<Image src="SMTP/3.Turn-on-app-access" alt="New-Form" w="586" h="314" />
...
<Image src="SMTP/4.App-Password" alt="New-Form" w="851" h="331" />

<Image src="SMTP/5.Sign-in" alt="New-Form" w="455" h="508" />

✔ Then set a app name or any other custom name to generate the password.

<Image src="SMTP/6.Set-Name" alt="New-Form" w="768" h="603" />

✔ In the next window a password will be automatically generated.

<Image src="SMTP/8.Generated-Password" alt="New-Form" w="646" h="466" />
