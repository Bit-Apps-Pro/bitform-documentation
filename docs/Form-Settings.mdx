...
<Image src="Bit-Form-single-entry-for-ip-address" alt="Form Settings" w="1000" h="300" />

### Require user to be logged in for submitting form
Enabling this option, users have to be logged in for form submission. You can set an error message to notify your user to log in 

<Image src="Form-Settings/Require-Log-In-Bit-Form" alt="Form Settings" w="1000" h="230" />

### Disallow empty form submission
Enabling this option, users can't submit empty form. If users try to submit empty form then admin can display an error message from the `Form settings` option.

<Image src="Form-Settings/Disallow-Empty-Form-Bit-Form" alt="Form Settings" w="1000" h="250" />
...
<Image src="Form-Settings/Focus-Lost-Bit-Form" alt="Form Settings" w="1000" h="250" />

### Disable entry storing in WordPress database
Enabling this option your form submission data will not be stored in Bit Form responses.

<Image src="Form-Settings/Data-Storing-Bit-Form" alt="Form Settings" w="1000" h="250" />
...
<Image src="Bit-Form-limited-entry" alt="Form Settings" w="1000" h="300" />
...
<Image src="Honeypot-Bit-Form (2)" alt="Form Settings" w="1000" h="300" />
...
<Image src="Bit-Form-limit-period" alt="Form Settings" w="1000" h="300" />
...
<Image src="Bit-Form-block-ip" alt="Form Settings" w="1000" h="300" />
...
<Image src="Bit-Form-allowed-ip" alt="Form Settings" w="1000" h="300" />
...
<Image src="SMTP/SMTP_1" alt="Form Settings" w="1000" h="650" />
...
<Image src="SMTP/Gmail" alt="Form Settings" w="346" h="500" />

✔ Navigate to the **Security** option. From this option you will find **Less security Apps** window.

<Image src="SMTP/1.Security" alt="Form Settings" w="324" h="431" />

<Image src="SMTP/2.App-access-window" alt="Form Settings" w="852" h="260" />

✔ Now, turn ON the **Allow less secure apps**.

<Image src="SMTP/3.Turn-on-app-access" alt="Form Settings" w="586" h="314" />
...
<Image src="SMTP/4.App-Password" alt="Form Settings" w="851" h="331" />

<Image src="SMTP/5.Sign-in" alt="Form Settings" w="455" h="508" />

✔ Then set a app name or any other custom name to generate the password.

<Image src="SMTP/6.Set-Name" alt="Form Settings" w="768" h="603" />

✔ In the next window a password will be automatically generated.

<Image src="SMTP/8.Generated-Password" alt="Form Settings" w="646" h="466" />

***2. Zoho Mail:***

✔ Log-in to your Zoho mail account. 

<Image src="zoho-mail/1.Login" alt="zoho mail" w="396" h="492" />

✔ Navigate to the 'Security' option. From this option you will find "App Passwords" window.

<Image src="zoho-mail/2.Security" alt="zoho mail" w="1293" h="400" />

✔ Click on "Generate New Password.

<Image src="zoho-mail/3.New-Password" alt="zoho mail" w="968" h="350" />

✔ Then set a app name to generate the password.

<Image src="zoho-mail/4.App-Name" alt="zoho mail" w="608" h="319" />

✔ In the next window a password will be automatically generated.

<Image src="zoho-mail/4.App-Name" alt="zoho mail" w="600" h="350" />
...
***Let’s see an example to clear this out!***
 ...
 <Image src="SMTP/SMTP_2" alt="Form Settings" w="1000" h="300" />
 <Video youtube src="gCfsPYBILLU" alt="SMTP" w="800" h="400" />
...
1. At first, go to your WordPress dashboard, then click on Bit Form.
 ...
 <Image src="Form-Import-Export/Dashboard-to-BitForm-" alt="Form Settings" w="1000" h="300" />
...
3. Then click on the menu from the right side of the selected form.
 ...
 <Image src="Form-Import-Export/Select-the-menu" alt="Form Settings" w="1000" h="300" />
...
4. Choose ***Export*** among the actions. By clicking this option, you can only export the form & related other styling & integration, but not the entries related to the selected form.
 ...
 <Image src="Form-Import-Export/Select-Export" alt="Form Settings" w="1000" h="300" />
...
2. Now click on the ***Create Form***, hover to the (+) icon & you can see the ***Import*** option. Click on the option.
 ...
 <Image src="Form-Import-Export/Create-Form" alt="Form Settings" w="1000" h="300" />
 <Image src="Form-Import-Export/Import" alt="Form Settings" w="1000" h="300" />
...
3. Then, click on ***Choose File*** & upload the downloaded JSON file from your computer. Here you have to select the property that you want to import with your form. They are:
 ...
 <Image src="Form-Import-Export/Choose-file-property" alt="Form Settings" w="1000" h="300" />
