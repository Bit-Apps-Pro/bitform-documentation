...
|Label			|Key			|
|----------------|----------------------------------|
|[Current Date Time](#current-date-time)	|<Copy text="${_bf_current_time}" />
|[Administrator Email](#administrator-email)	|<Copy text='${_bf_admin_email}' />
|[Date (default format)](#default-date-format)	|<Copy text='${_bf_date_default}' />
|[Date(mm/dd/yy)](#default-date-format)	| <Copy text='${_bf_date.m/d/y}' /> 
|[Date(dd/mm/yy)](#default-date-format)	|<Copy text='${_bf_date.d/m/y}' />
|[Date(Y/m/d](#default-date-format)	| 	<Copy text='${_bf_date.y/m/d}' />
|[Time](#time)	| 	<Copy text='${_bf_time}' />
|[Weekday](#weekday)	|	<Copy text='${_bf_weekday}' />
|[Referer URL](#refer-url)	|<Copy text="${_bf_http_referer_url}" />
...
|Label			|Key			|
|----------------|-------------------------------|
|[User IP Address](#user-ip-address)	|<Copy text='${_bf_ip_address}' />	
|[Browser Name](#browser-name)	|<Copy text='${_bf_browser_name}' /> 
|[Random Digit](#random-digit)	|<Copy text='${_bf_random_digit_num}' /> 
|[Operating System](#operating-system)	|<Copy text="${_bf_operating_system}" />
...
|Label			|Key			|
|----------------|-------------------------------|
|[Post Author ID](#post-author-id)	| <Copy text='${_bf_author_id}' />
|[Post Author Display Name](#post-author-display-name)	|<Copy text='${_bf_author_display}' />
|[Post Author Email](#post-author-email)	|<Copy text='${_bf_author_email}' /> 
...
|Label			|Key			|
|----------------|-------------------------------|	
|[User ID](#user-id)	|	<Copy text='${_bf_user_id}' />
|[User First Name](#user-first-name)	|	<Copy text='${_bf_user_first_name}' />
|[User Last Name](#user-last-name)	| <Copy text='${_bf_user_last_name}' />
|[User Display Name](#user-display-name)	|<Copy text='${_bf_user_display_name}' />
|[User Nice Name](#user-nice-name)	| <Copy text='${_bf_user_nice_name}' />
|[User Login Name](#user-login-name)	|<Copy text='${_bf_user_login_name}' />
|[User Email](#user-email)	| <Copy text='${_bf_user_email}' />
|[User URL](#user-url)	|	<Copy text='${_bf_user_url}' />
|[Current User Role](#current-user-role)	|	<Copy text='${_bf_current_user_role}' />
|[Site Title](#site-title)	|	<Copy text='${_bf_site_title}' />
|[Site Description](#site-description)	| 	<Copy text='${_bf_site_description}' />
|[Site URL](#site-url)	|<Copy text='${_bf_site_url}' />
|[WordPress Locale Code](#wordpress-local-code)	|  	<Copy text='${_bf_wp_local_codes}' />
|[Embedded Page / Post ID](#page-post-id)	| 	<Copy text='${_bf_post_id}' />
|[Embedded Page / Post Name](#page-post-name)	|  	<Copy text='${_bf_post_name}' />
|[Embedded Page / Post Title](#page-post-title)	|<Copy text='${_bf_post_title}' />
|[Embedded Page / Post URL](#page-post-url)	| 	<Copy text='${_bf_post_url}' />
|[Post Publish Date](#post-publish-date)	|  <Copy text='${_bf_post_date}' />
|[Post Modified Date](#post-modified-date)	|  <Copy text='${_bf_post_modified_date}' />
|[URL Query Parameter](#url-query-parameter)	|  	<Copy text='${_bf_query_param()}' />
|[User Meta Key](#user-meta-key)	| 	<Copy text='${_bf_user_meta_key()}' />
|[Custom Date Format](#custom-date-format)	| <Copy text='${_bf_custom_date_format()}' />
